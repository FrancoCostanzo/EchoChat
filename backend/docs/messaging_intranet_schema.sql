...
-- DATOS INICIALES
-- =============================================================================
-- Los datos de referencia (roles, permisos, su mapeo y la configuración por
-- defecto) NO viven en este archivo: están en docs/seed.sql, que el backend
-- aplica de forma idempotente en CADA arranque (ver src/config/migrate.js).
-- Este archivo es solo DDL.
