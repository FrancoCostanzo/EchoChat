...
function createInitialState(word) {
  return { word, guessed: [], wrong: [], winner: null };
}

function isFullyGuessed(word, guessed) {
...
module.exports = { createInitialState, applyGuess, maskWord, MAX_WRONG };
