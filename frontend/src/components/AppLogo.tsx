...
const SIZES: Record<LogoSize, { box: string; px: number; rounded: string }> = {
...
export function AnimatedLogoMark({ loop = false, className = '' }: AnimatedLogoMarkProps) {
...
export function AuthBrandHeader({ subtitle }: { subtitle?: ReactNode }) {
