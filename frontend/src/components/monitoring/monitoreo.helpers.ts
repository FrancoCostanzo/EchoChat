...
export const formatMicroseconds = (value: number | null | undefined): string => {
...
export const getStatusColor = (status: string | null | undefined) => monitoreoServices.getStatusColor(status);

const HTTP_METHODS = new Set(['GET', 'POST', 'PUT', 'PATCH', 'DELETE', 'OPTIONS', 'HEAD']);

export interface ParsedHttpRoute {
  method: string | null;
  path: string;
}

export const parseHttpRoute = (routeLabel: string | null | undefined): ParsedHttpRoute => {
...
/** Devuelve un color válido de Chip ("accent"|"default"|"success"|"warning"|"danger") — no hay "primary"/"secondary". */
export const getHttpMethodColor = (method: string | null | undefined): 'accent' | 'default' | 'success' | 'warning' | 'danger' => {
