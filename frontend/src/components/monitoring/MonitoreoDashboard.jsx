...
function renderTabContent(activeTab, dashboard) {
  switch (activeTab) {
    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Chip size="sm" variant="dot" color={getStatusColor(server?.status)}>
            {t('monitoring.tabs.server')}
          </Chip>
          <Chip size="sm" variant="dot" color={getStatusColor(db?.status)}>
