...
import type { CallResponse, CallType } from '@/types/call';
...
interface CallHistoryPanelProps {
  ...
  selfId: string;
  onClose: () => void;
  onCallAgain?: (type: CallType) => void;
}

export default function CallHistoryPanel({ conversationId, selfId, onClose, onCallAgain }: CallHistoryPanelProps) {
  const { t } = useTranslation();
  const [items, setItems] = useState<CallResponse[]>([]);
            ...
            return (
              ...
              >
                ...
                <Button
                  ...
                  size="sm"
                  variant="ghost"
                  onPress={() => onCallAgain?.(call.type as CallType)}
