...
function DockOrb({ icon: Icon, label, onClick, active, variant = 'default', badge = 0, tooltipPlacement = 'right' }: DockOrbProps) {
...
interface ServerOrbitDockProps {
