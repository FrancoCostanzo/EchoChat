...
/* ─────────────────────────────────────────────────────────
   ...
   ───────────────────────────────────────────────────────── */
export default function PinnedMessagesPanel({ conversationId, onClose, onJump, onUnpinned }: PinnedMessagesPanelProps) {
        ...
        <div className="flex flex-col gap-1">
          {items.map((msg) => (
            ...
            >
              ...
              >
                <div className="flex items-center gap-2">
                  {/* La API de mensajes no manda una URL de avatar resuelta (sólo
                      sender_avatar_key, un object key sin presignar) — igual que
